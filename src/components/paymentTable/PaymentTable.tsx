...
interface PropsType {
  ...
  price: number;
  handleShoppingCartClear: () => void;
  handleCheckout: () => void;
}

//payment table in shopping cart page
export const PaymentTable: React.FC<PropsType> = ({
  loading,
  originalPrice,
  price,
  ...
  return (
    <Card
      ...
      actions={[
        ...
        <Button onClick={handleShoppingCartClear} loading={loading}>
          <DeleteOutlined />
          清空
        </Button>,
      ]}
